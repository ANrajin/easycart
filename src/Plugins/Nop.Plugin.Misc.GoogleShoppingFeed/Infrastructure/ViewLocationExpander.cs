...
public class ViewLocationExpander : IViewLocationExpander
{
        ...
        IEnumerable<string> viewLocations)
    {
        ...
        if (theme is null or "DefaultClean")
            viewLocations = new[] {
                $"/Plugins/Misc.GoogleShoppingFeed/Views/{{1}}/{{0}}.cshtml",
                $"/Plugins/Misc.GoogleShoppingFeed/Views/Shared/{{0}}.cshtml",
            }.Concat(viewLocations);
        else
            viewLocations = new[] {
                $"/Plugins/Misc.GoogleShoppingFeed/Views/{{1}}/{{0}}.cshtml",
                $"/Plugins/Misc.GoogleShoppingFeed/Views/Shared/{{0}}.cshtml",
                $"/Plugins/Misc.GoogleShoppingFeed/Themes/{theme}/Views/{{1}}/{{0}}.cshtml",
                $"/Plugins/Misc.GoogleShoppingFeed/Themes/{theme}/Views/Shared/{{0}}.cshtml",
            }.Concat(viewLocations);
